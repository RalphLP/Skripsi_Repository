...
use App\Http\Controllers\GymoveadminController;
...
/* LOGIN */
Route::get('/login-index', [LoginController::class, 'index_login'])->name('login.post');
Route::post('/login-index', [LoginController::class, 'customLogin'])->name('login.posts');
Route::post('/logout-post', [LoginController::class, 'logout'])->name('logout.post');
Route::get('/register-index', 'App\Http\Controllers\LoginController@index_register');
Route::post('/register-index', 'App\Http\Controllers\LoginController@store')->name('register.post');
...
Route::middleware(['auth'])->group(function () {
    ...
    Route::get('/detail-datamahasiswa/{id}', 'App\Http\Controllers\RepositoryController@detail_mahasiswa');
    Route::get('/daftar-dosen', 'App\Http\Controllers\RepositoryController@daftar_dosen');
    Route::get('/detail-datadosen/{id}', 'App\Http\Controllers\RepositoryController@detail_dosen');
